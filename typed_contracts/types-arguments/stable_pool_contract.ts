...
export interface TokenRate {
	constant ? : (string | number | BN),
	external ? : ExternalTokenRate
}

export class TokenRateBuilder {
	static Constant(value: (string | number | BN)): TokenRate {
		return {
			constant: value,
		};
	}
...
export type ExternalTokenRate = {
	cachedTokenRate: (string | number | BN),
	lastTokenRateUpdateTs: (number | string | BN),
	tokenRateContract: AccountId,
	expirationDurationMs: (number | string | BN)
}
...
export interface MathError {
	addOverflow ? : (number | string | BN),
	castOverflow ? : (number | string | BN),
	divByZero ? : (number | string | BN),
	mulOverflow ? : (number | string | BN),
	subUnderflow ? : (number | string | BN),
	precision ? : (number | string | BN)
}

export class MathErrorBuilder {
	static AddOverflow(value: (number | string | BN)): MathError {
		return {
			addOverflow: value,
		};
	}
	static CastOverflow(value: (number | string | BN)): MathError {
		return {
			castOverflow: value,
		};
	}
	static DivByZero(value: (number | string | BN)): MathError {
		return {
			divByZero: value,
		};
	}
	static MulOverflow(value: (number | string | BN)): MathError {
		return {
			mulOverflow: value,
		};
	}
	static SubUnderflow(value: (number | string | BN)): MathError {
		return {
			subUnderflow: value,
		};
	}
	static Precision(value: (number | string | BN)): MathError {
		return {
			precision: value,
		};
	}
